...
RUN_TAG=rep_eval_3models_convnexttiny_probe_seed123_t08_4x5090
...
TIMESTEPS=${TIMESTEPS:-0.8} \
CLASS_PROBES=convnext_tiny_probe \
CLASS_MAIN_PROBE=convnext_tiny_probe \
CLASS_EXTRACT_BATCH_SIZE=${CLASS_EXTRACT_BATCH_SIZE:-4} \
CLASS_CNN_LAYER_BATCH_SIZE=${CLASS_CNN_LAYER_BATCH_SIZE:-1} \
SEG_EXTRACT_BATCH_SIZE=${SEG_EXTRACT_BATCH_SIZE:-${CLASS_EXTRACT_BATCH_SIZE:-4}} \
...
CKA_BATCH_SIZE=${CKA_BATCH_SIZE:-16} \
